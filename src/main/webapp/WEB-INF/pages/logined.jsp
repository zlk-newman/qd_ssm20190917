            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/static/Hplus-v.4.1.0/img/profile_small.jpg" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath}/forward?pg=userInfoManager/userInfoAdd" data-index="0">用户信息新增</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0" href="index_v2.html">主页示例二</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0" href="index_v3.html">主页示例三</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0" href="index_v4.html">主页示例四</a>
                        </li>
                        <li>
